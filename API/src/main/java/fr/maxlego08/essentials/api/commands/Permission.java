...
public enum Permission {
    ...
    ESSENTIALS_FLY_SAFELOGIN("Players with this permission will automatically enter fly mode upon logging in if they are suspended in the air."), ESSENTIALS_SUICIDE, ESSENTIALS_ECO_GIVE_RANDOM, ESSENTIALS_CLEAR_RANDOM_WORD, ESSENTIALS_DISCORD_LINK;
