...
public class CommandTradeDeny extends VCommand {

    public CommandTradeDeny(EssentialsPlugin plugin) {
        super(plugin);
        this.addSubCommand("deny");
        this.setPermission(Permission.ESSENTIALS_TRADE_DENY);
    ...
    protected CommandResultType perform(EssentialsPlugin plugin) {
        ...
        if (args.length == 0) {
            ...
            if (senderUUID != null) {
                ...
                if (senderPlayer != null) {
                    manager.denyRequest(senderPlayer, player);
        ...
        manager.denyRequest(target, player);
        return CommandResultType.SUCCESS;
    }
}
