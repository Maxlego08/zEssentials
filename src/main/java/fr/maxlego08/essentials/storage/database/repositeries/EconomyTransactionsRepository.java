...
public class EconomyTransactionsRepository extends Repository {
    ...
    /*public void insert(UUID fromUuid, UUID toUuid, Economy economy, BigDecimal fromAmount, BigDecimal toAmount, String reason) {
        insert(table -> {
    ...
    public void insertTransactions(List<EconomyTransactionDTO> transactions){
        insert(transactions.stream().map(transaction -> schema(table -> {
