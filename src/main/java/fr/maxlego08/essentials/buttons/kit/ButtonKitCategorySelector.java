...
public class ButtonKitCategorySelector extends Button {

    private final EssentialsPlugin plugin;
    private final String categoryName;

    public ButtonKitCategorySelector(EssentialsPlugin plugin, String categoryName) {
        this.plugin = plugin;
    ...
    public void onClick(Player player, InventoryClickEvent event, InventoryEngine inventory, int slot, Placeholders placeholders) {
        ...
        if (kits.isEmpty()) {
            return; // No kits in this category
        }
    ...
    public boolean checkPermission(Player player, InventoryEngine inventory, Placeholders placeholders) {
        ...
        // Only show category if player has access to at least one kit in it
