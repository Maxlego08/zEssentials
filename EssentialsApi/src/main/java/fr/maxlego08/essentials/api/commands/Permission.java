...
public enum Permission {
    ...
    ESSENTIALS_GIVE, ESSENTIALS_GIVE_ALL, ESSENTIALS_ITEM_LORE_CLEAR, ESSENTIALS_POWER_TOOLS, ESSENTIALS_POWER_TOOLS_TOGGLE, DESCRIPTION_POWER_TOOLS_TOGGLE_OTHER, ESSENTIALS_KIT_SHOW, ESSENTIALS_MAIL;
