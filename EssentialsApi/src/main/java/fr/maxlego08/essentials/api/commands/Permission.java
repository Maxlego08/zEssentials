...
public enum Permission {
    ...
    ESSENTIALS_CHAT_BYPASS_ALPHANUMERIC, ESSENTIALS_CHAT_BYPASS_DYNAMIC_COOLDOWN, ESSENTIALS_CHAT_BYPASS_LINK, ESSENTIALS_CHAT_BYPASS_SAME_MESSAGE, ESSENTIALS_CHAT_BYPASS_DISABLE;
